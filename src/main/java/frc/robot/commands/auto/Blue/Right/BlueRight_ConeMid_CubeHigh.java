package frc.robot.commands.auto.Blue.Right;
...
public class BlueRight_ConeMid_CubeHigh extends SequentialCommandGroup {
    ...
    public BlueRight_ConeMid_CubeHigh(SwerveDriveSubsystem swerveDriveSubsystem, IntakeSubsystem intakeSubsystem, TelescopingArmSubsystem telescopingArmSubsystem, PivotSubsystem pivotSubsystem) {
        ...
        addCommands(                    
                ...
                new ParallelCommandGroup(
                    new AutoDriveToWayPoint(m_swerveDriveSubsystem, new Pose2d(AutoConstants.A2_BLUE_RIGHT_BUMPCHECK_IN[0]+startingX, AutoConstants.A2_BLUE_RIGHT_BUMPCHECK_IN[1]+startingY, new Rotation2d(Math.PI+startingRot)), false, true, true, 1.5),
                    new PivotCommand(m_pivotSubsystem, "up")
                ),

                // drive to cone + parallel with intake
                new ParallelCommandGroup(
                    new AutoDriveToWayPoint(m_swerveDriveSubsystem, new Pose2d(AutoConstants.A2_BLUE_RIGHT_BUMPCHECK_OUT[0]+startingX, AutoConstants.A2_BLUE_RIGHT_BUMPCHECK_OUT[1]+startingY, new Rotation2d(Math.PI+startingRot)), false, true, true, 0.75),

                    new PivotCommand(m_pivotSubsystem, "down")
                ),
                new AutoDriveToWayPoint(m_swerveDriveSubsystem, new Pose2d(AutoConstants.A2_BLUE_RIGHT_GAME_PIECE[0]+startingX, AutoConstants.A2_BLUE_RIGHT_GAME_PIECE[1]+startingY, new Rotation2d(Math.PI+startingRot)), false, true, true),
                new ParallelCommandGroup(
                    new DeadReckoning(swerveDriveSubsystem, -1, 0, 0.5),
                    new InstantCommand(() -> m_intakeSubsystem.runIntake(0), m_intakeSubsystem)
                ),
                new ParallelCommandGroup(
                    new AutoDriveToWayPoint(m_swerveDriveSubsystem, new Pose2d(AutoConstants.A2_BLUE_RIGHT_BUMPCHECK_OUT[0]+startingX, AutoConstants.A2_BLUE_RIGHT_BUMPCHECK_OUT[1]+startingY, new Rotation2d(0+startingRot)), false, true, false),
                    new InstantCommand(m_intakeSubsystem::stopIntake, m_intakeSubsystem),
                    new InstantCommand(m_pivotSubsystem::up)
                ),
                new AutoDriveToWayPoint(m_swerveDriveSubsystem, new Pose2d(AutoConstants.A2_BLUE_RIGHT_BUMPCHECK_IN[0]+startingX, AutoConstants.A2_BLUE_RIGHT_BUMPCHECK_IN[1]+startingY, new Rotation2d(0+startingRot)), false, true, false, 0.75),
                new ParallelCommandGroup(
                    new AutoDriveToWayPoint(m_swerveDriveSubsystem, new Pose2d(AutoConstants.A2_BLUE_RIGHT_MID_SCORING[0]+startingX, AutoConstants.A2_BLUE_RIGHT_MID_SCORING[1]+startingY, new Rotation2d(0+startingRot)), false, true, false),
