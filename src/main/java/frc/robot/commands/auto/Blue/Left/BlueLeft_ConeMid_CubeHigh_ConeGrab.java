...
public class BlueLeft_ConeMid_CubeHigh_ConeGrab extends SequentialCommandGroup {
    ...
    public BlueLeft_ConeMid_CubeHigh_ConeGrab(SwerveDriveSubsystem swerveDriveSubsystem, IntakeSubsystem intakeSubsystem, TelescopingArmSubsystem telescopingArmSubsystem, PivotSubsystem pivotSubsystem) {
        ...
        addCommands(                    
                ...
                new AutoDriveToWayPoint(m_swerveDriveSubsystem, new Pose2d(AutoConstants.A2_BLUE_LEFT_MID_POINT[0]+startingX, AutoConstants.A2_BLUE_LEFT_MID_POINT[1]+startingY, new Rotation2d(Math.PI/2+startingRot)), false, true, false),
                new ParallelCommandGroup(
                    new AutoDriveToWayPoint(m_swerveDriveSubsystem, new Pose2d(AutoConstants.A2_BLUE_LEFT_2GAME_PIECE[0]+startingX, AutoConstants.A2_BLUE_LEFT_2GAME_PIECE[1]+startingY, new Rotation2d(Math.PI/2+startingRot)), true, true, true),
                    new PivotCommand(m_pivotSubsystem, "down")
                ),

                new ParallelRaceGroup(
                    new IntakeCommand(m_intakeSubsystem),
                    new DeadReckoning(swerveDriveSubsystem, 0, 1.0, 1.13)
                ),
                new ParallelCommandGroup(
                    new AutoDriveToWayPoint(m_swerveDriveSubsystem, new Pose2d(AutoConstants.A2_BLUE_LEFT_MID_POINT[0]+startingX, AutoConstants.A2_BLUE_LEFT_MID_POINT[1]+startingY, new Rotation2d(0+startingRot)), false, false, true),
                    new InstantCommand(m_pivotSubsystem::storedPosition, m_pivotSubsystem)
                )

                // new AutoDriveToWayPoint(m_swerveDriveSubsystem, new Pose2d(AutoConstants.A2_RED_COMMUNITY_RIGHT_SCORING[0]+startingX, AutoConstants.A2_RED_COMMUNITY_RIGHT_SCORING[1]+startingY, new Rotation2d(0+startingRot)), false, true, false),
                // new AutoDriveToWayPoint(m_swerveDriveSubsystem, new Pose2d(AutoConstants.A2_BLUE_LEFT_MID_SCORING2[0]+startingX, AutoConstants.A2_BLUE_LEFT_MID_SCORING2[1]+startingY, new Rotation2d(0+startingRot)), true),
