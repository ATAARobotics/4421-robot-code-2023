...
public class Red3PieceStartConeRight extends SequentialCommandGroup {
    ...
    public Red3PieceStartConeRight(SwerveDriveSubsystem swerveDriveSubsystem, IntakeSubsystem intakeSubsystem, TelescopingArmSubsystem telescopingArmSubsystem, PivotSubsystem pivotSubsystem) {
        ...
        addCommands(                    
                ...
                new ParallelCommandGroup(
                    new AutoDriveToWayPoint(m_swerveDriveSubsystem, new Pose2d(AutoConstants.A2_RED_RIGHT_GAME_PIECE[0]+startingX, AutoConstants.A2_RED_RIGHT_GAME_PIECE[1]+startingY, new Rotation2d(Math.PI+startingRot)), true, true, true),
                    new InstantCommand(m_pivotSubsystem::downSlow, m_pivotSubsystem)
                ),

                new ParallelRaceGroup(
                    new IntakeCommand(m_intakeSubsystem),
                    new DeadReckoning(swerveDriveSubsystem, -1.5, 0, 1)
                ...
                new DeadReckoning(m_swerveDriveSubsystem, 1.5, 0, 0.4),
                // score
                ...
                new ParallelRaceGroup(
                    new IntakeCommand(m_intakeSubsystem),
                    new DeadReckoning(swerveDriveSubsystem, -1.5, 0, 0.75)
                ),
                new ParallelCommandGroup(
