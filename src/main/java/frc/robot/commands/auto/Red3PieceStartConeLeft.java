...
public class Red3PieceStartConeLeft extends SequentialCommandGroup {
    ...
    public Red3PieceStartConeLeft(SwerveDriveSubsystem swerveDriveSubsystem, IntakeSubsystem intakeSubsystem, TelescopingArmSubsystem telescopingArmSubsystem, PivotSubsystem pivotSubsystem) {
        ...
        addCommands(                    
                ...
                new ParallelCommandGroup(
                    new AutoDriveToWayPoint(m_swerveDriveSubsystem, new Pose2d(AutoConstants.A2_RED_LEFT_GAME_PIECE[0]+startingX, AutoConstants.A2_RED_LEFT_GAME_PIECE[1]+startingY, new Rotation2d(Math.PI+startingRot)), true),
                ...
                // drive into scoring in 1 command
                new AutoDriveToWayPoint(m_swerveDriveSubsystem, new Pose2d(AutoConstants.A2_RED_LEFT_MID_SCORING[0]+startingX, AutoConstants.A2_RED_LEFT_MID_SCORING[1]+startingY, new Rotation2d(0+startingRot)), true),
                ...
                new ParallelCommandGroup(
                    new AutoDriveToWayPoint(m_swerveDriveSubsystem, new Pose2d(AutoConstants.A2_RED_LEFT_2GAME_PIECE[0]+startingX, AutoConstants.A2_RED_LEFT_2GAME_PIECE[1]+startingY, new Rotation2d(Math.PI+startingRot)), true, true, true),
                    new PivotCommand(m_pivotSubsystem, "down")
                ),
