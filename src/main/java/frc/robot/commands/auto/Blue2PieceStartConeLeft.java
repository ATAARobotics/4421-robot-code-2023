...
public class Blue2PieceStartConeLeft extends SequentialCommandGroup {
    ...
    public Blue2PieceStartConeLeft(SwerveDriveSubsystem swerveDriveSubsystem, IntakeSubsystem intakeSubsystem, TelescopingArmSubsystem telescopingArmSubsystem, PivotSubsystem pivotSubsystem) {
