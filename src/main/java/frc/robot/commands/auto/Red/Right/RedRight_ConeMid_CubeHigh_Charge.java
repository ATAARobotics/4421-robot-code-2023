...
public class RedRight_ConeMid_CubeHigh_Charge extends SequentialCommandGroup {
    ...
    public RedRight_ConeMid_CubeHigh_Charge(SwerveDriveSubsystem swerveDriveSubsystem, IntakeSubsystem intakeSubsystem, TelescopingArmSubsystem telescopingArmSubsystem, PivotSubsystem pivotSubsystem) {
