...
public class RedCenter_CubeMid_Charge extends SequentialCommandGroup {
    ...
    public RedCenter_CubeMid_Charge(SwerveDriveSubsystem swerveDriveSubsystem, IntakeSubsystem intakeSubsystem, TelescopingArmSubsystem telescopingArmSubsystem, PivotSubsystem pivotSubsystem) {
