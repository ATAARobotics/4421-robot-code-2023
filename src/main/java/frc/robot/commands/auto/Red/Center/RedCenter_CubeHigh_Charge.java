...
public class RedCenter_CubeHigh_Charge extends SequentialCommandGroup {
    ...
    public RedCenter_CubeHigh_Charge(SwerveDriveSubsystem swerveDriveSubsystem, IntakeSubsystem intakeSubsystem, TelescopingArmSubsystem telescopingArmSubsystem, PivotSubsystem pivotSubsystem) {
